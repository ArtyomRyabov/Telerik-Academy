...
class HexadecimalToBinary
{
    static void Main()
    {
        ...
        Console.WriteLine("Converted to binary: {0}", HexadecimalToBinaryNumber(hexadecimalNumber));
    }

    private static string HexadecimalToBinaryNumber(string hexadecimalNumber)
    {
